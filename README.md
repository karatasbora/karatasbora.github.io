...
[![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen)](https://karatasbora.github.io/me/)
[![Status](https://img.shields.io/badge/Status-Active-success)]()

**Innovative Education Specialist & Instructional Technologist | AI-Supported Instructional Design** *Eskisehir, Turkey*
...
### [arc – AI-Powered Educational Material Generator](https://karatasbora.github.io/arc/)
*2026 | Full Stack Developer*
An innovative educational tool designed to autonomously produce CEFR-aligned worksheets.
* **Tech Stack:** React 19, Google Gemini API, jsPDF (Client-side PDF engine).
* **Key Features:** Advanced prompt engineering for deterministic JSON outputs and dynamic scaffolding.

## 🎓 Education

* **Anadolu University:** Bachelor's Degree in English Language Teaching.
* **Universidade de Coimbra:** ERASMUS+ in Anglo-American Studies.
* **Anadolu University:** Bachelor's Degree in Economics (English).

## 🧩 Skills

| Category | Skills |
| :--- | :--- |
| **Technology & AI** | Generative AI, Prompt Engineering, Web Development, LMS, CMS, Digital Transformation |
